...
$('.game-start').click( function () {
    ...
    var grawKvadrat = function (kvadrat) {
      var left = Math.random()*598;
      var top = Math.random()*598;
        kvadrat.css({
            left: left,
            top: top
        });
...
//                startTime()
//            },1000);
//        var kvadrat = $('<div class="kvadrat"></div>');
//        $('.kvad').append(kvadrat);
//            grawKvadrat(kvadrat);
//        setTimeout(function () {
//            calculation_kvad.init()
//            pause = false;
//            kvadrat = $('<div class="kvadrat"></div>');
//            $('.kvad').append(kvadrat);
//            grawKvadrat(kvadrat);
//        },1000)}
//        else{
